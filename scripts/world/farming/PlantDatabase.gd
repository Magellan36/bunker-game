...
const PLANT_CONFIG: Dictionary = {
	"tomato": {
		"display_name": "Tomato", "grow_days": 10.0, "category": "Vegetable",
	...
	"onion": {
		"display_name": "Onion", "grow_days": 20.0, "category": "Vegetable",
	...
	"basil": {
		"display_name": "Basil", "grow_days": 5.0, "category": "Herb",
	...
	"strawberry": {
		"display_name": "Strawberry", "grow_days": 7.0, "category": "Fruit",
	...
	"carrot": {
		"display_name": "Carrot", "grow_days": 8.0, "category": "Vegetable",
	...
	"chili_pepper": {
		"display_name": "Chili Pepper", "grow_days": 9.0, "category": "Herb",
	...
	"bell_pepper": {
		"display_name": "Bell Pepper", "grow_days": 12.0, "category": "Vegetable",
	...
	"garlic": {
		"display_name": "Garlic", "grow_days": 14.0, "category": "Vegetable",
	...
	"potato": {
		"display_name": "Potato", "grow_days": 16.0, "category": "Vegetable",
	...
	"blueberry": {
		"display_name": "Blueberry", "grow_days": 18.0, "category": "Fruit",
	...
	"corn": {
		"display_name": "Corn", "grow_days": 22.0, "category": "Vegetable",
	...
	"pumpkin": {
		"display_name": "Pumpkin", "grow_days": 30.0, "category": "Fruit",
