...
## and a 2×3 grid of drawer faces + knobs on the -Z (front) side.
## Footprint 1.90×0.90.

const BODY_SIZE: Vector3 = Vector3(1.90, 1.50, 0.90)
const TOP_THICKNESS: float = 0.05
const TOP_SIZE: Vector3 = Vector3(1.96, TOP_THICKNESS, 0.96)
const TOP_Y: float = BODY_SIZE.y + TOP_THICKNESS * 0.5
const DRAWER_W: float = 0.60
const DRAWER_H: float = 0.38
