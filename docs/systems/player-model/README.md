...
headless measurement — `Vector3(0.0, -1.586469, 0.057)` — because the
...
`(0.0, 0.78, -0.037)`). The `-1.586469` Y includes follow-up -0.02
adjustments applied after in-game confirmation that the hair sat a bit
too high on the skull (hair center now `y≈0.74`). Adjust by eye in the
